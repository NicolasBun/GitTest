...
namespace embree
{
  ...
  __forceinline const Vec3<float> sign ( const Vec3<float>& a ) { return _mm_blendv_ps(Vec3<float>(one), -Vec3<float>(one), _mm_cmplt_ps (a,Vec3<float>(zero))); }
 ...
 ////////////////////////////////////////////////////////////////////////////////
  ...
  __forceinline const Vec3<float> set_if_zero( const Vec3<float>& a, const Vec3<float>& b ) {
    return _mm_blendv_ps(a.m128, b.m128, _mm_cmpeq_ps (a.m128, _mm_setzero_ps()));
  }
