...
namespace embree
{
  ...
  class TriangleLight : public AreaLight
  {
    ...
    TriangleLight (const Vec3f& v0, const Vec3f& v1, const Vec3f& v2, const Col3f& L)
      : v0(v0), v1(v1), v2(v2), e1(v1-v0), e2(v2-v0), Ng(cross(e1,e2)), L(L), tri(new Triangle(v0,v1,v2)) { }
  ...
  public:
    ...
    Ref<Light> transform(const AffineSpace& xfm) const {
    ...
    Col3f sample(const DifferentialGeometry& dg, Sample3f& wi, float& tMax, const Vec2f& s) const
    {
      ...
      wi = Sample3f(d*rcp(tMax),2.0f*tMax*tMax*tMax/fabs(dDotNg));
      return L;
    }
