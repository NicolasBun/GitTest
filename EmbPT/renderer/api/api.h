...
namespace embree
{
  ...
  *******************************************************************/
  ...
  /*! Creates a new material.
	 * \param type is the type of material to
  ...
  *******************************************************************/
  ...
  /*! Renders a frame.
	 ...
	 * \param camera is the camera to use
	 * \param scene is the scene to render
   * \param frameBuffer is the framebuffer to render into */
  RT_API_SYMBOL void rtRenderFrame(RTRenderer renderer, RTCamera camera, RTScene scene, RTFrameBuffer frameBuffer);

  /*! Traces rays.
	 * \param rays is an array of rays to trace
	 * \param scene is the scene to trace the rays in
	 * \param hits is an array that is overwritten with the result
	 * \param numRays are the number of rays to shoot */
  RT_API_SYMBOL void rtTraceRays(const RTRay* rays, RTScene scene, RTHit* hits, size_t numRays);

  /*! Pick a 3D point.
	 * \returns true if a point was picked, false otherwise
   * \param x is the x coordinate [0:1] in the image plane
   * \param y is the y coordinate [0:1] in the image plane
   * \param p is the world space position of the picked point, if any
   * \param camera is the camera to use
	 * \param scene is the scene for picking */
