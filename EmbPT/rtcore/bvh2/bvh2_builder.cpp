...
namespace embree
{
  ...
  __forceinline BVH2Builder::BuildTask::BuildTask(BVH2Builder* parent, int& nodeID, size_t depth, const ObjectBinning<2>& job)
  ...
  __forceinline BVH2Builder::SplitTask::SplitTask(BVH2Builder* parent, int& nodeID, size_t depth, const ObjectBinning<2>& job)
  ...
  __forceinline BVH2Builder::ParallelSplitTask::ParallelSplitTask(BVH2Builder* parent, int& nodeID, size_t depth, const BuildRange& job)
