...
namespace embree
{
  ...
  struct __align(16) BuildTriangle
  {
    /*! Constructs a builder triangle. */
    __forceinline BuildTriangle(const Vec3f& v0,   //!< 1st vertex of the triangle
    ...
    /*! Returns the 1st vertex of the triangle as SSE vector. */
    __forceinline ssef& v0() const { return *(ssef*)&x0; }

    /*! Returns the 2nd vertex of the triangle as SSE vector. */
    __forceinline ssef& v1() const { return *(ssef*)&x1; }

    /*! Returns the 3rd vertex of the triangle as SSE vector. */
    __forceinline ssef& v2() const { return *(ssef*)&x2; }

    /*! Returns the n'th vertex of the triangle as SSE vector. */
    __forceinline const ssef& operator[](size_t idx) const { return ((ssef*)this)[idx]; }
